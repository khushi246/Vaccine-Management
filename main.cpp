...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "chanchal") == 0) && (strcmp(a_password, "123456") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
...
A:
    ...
    case 1:
    {
        ...
        cin >> add;
        sum_vaccine_c1 = int(sum_vaccine_c1) + int(add);
        file << sum_vaccine_c1;
        file.close();
...
void covid_management::display_vaccine_stock()
{
    ...
    cout<<"TOTAL_VACCINE: "<<TOTAL_VACCINE<<endl;
    cout<<"sum_vaccine_c1: "<<sum_vaccine_c1<<endl;
    cout<<"sum_vaccine_c2: "<<sum_vaccine_c2<<endl;
    cout<<"sum_vaccine_c3: "<<sum_vaccine_c3<<endl;

    cout << "\n\nPrinting s: " << s;
    //cout << "\n\nAvailable Number Of Vaccines are: " << ;
    file1.close();
    file2.close();
    file3.close();
